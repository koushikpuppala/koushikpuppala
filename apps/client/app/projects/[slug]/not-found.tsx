			...
			<PageContainer className='max-w-2xl mx-auto text-center space-y-8 my-auto'>
				<Surface
					...
					<div className='inline-flex items-center gap-2 font-mono text-xs text-signal font-semibold uppercase tracking-widest'>
						...
						<span>ERROR 404 {'//'} SPECIFICATION NOT FOUND</span>
					</div>

					<div className='space-y-3'>
						<h1 className='text-3xl sm:text-4xl font-display font-bold tracking-tight text-foreground'>
							System Specification Unavailable
						</h1>
						<p className='text-sm sm:text-base text-muted-foreground leading-relaxed'>
							The requested project identifier could not be resolved against the published system
							registry. It may have been renamed, archived, or temporarily withdrawn.
						</p>
					</div>
