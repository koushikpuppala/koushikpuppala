...
!(function (e, t) {
  ...
  var m = e.document
  var y = { type: !0, src: !0, nonce: !0, noModule: !0 }
  function g (e, t, n) {
    var i
    var r
  ...
  w.extend({
    ...
    map: function (e, t, n) {
      ...
      var s = []
      if (k(e)) {
        for (i = e.length; a < i; a++) { (r = t(e[a], a, n)) != null && s.push(r) }
      } else for (a in e) (r = t(e[a], a, n)) != null && s.push(r)
      return o(s)
    },
    guid: 1,
    support: f
  ...
  var C = (function (e) {
    ...
    var B = new RegExp('^' + I + '+|((?:^|[^\\\\])(?:\\\\.)*)' + I + '+$', 'g')
    var W = new RegExp('^' + I + '*,' + I + '*')
    var $ = new RegExp('^' + I + '*([>+~]|' + I + ')' + I + '*')
    var U = new RegExp(I + '|>')
    var X = new RegExp(z)
    var Q = new RegExp('^' + H + '$')
    var J = {
    ...
    var Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/
    var ee = /[+~]/
    var te = new RegExp('\\\\[\\da-fA-F]{1,6}' + I + '?|\\\\([^\\r\\n\\f])', 'g')
    var ne = function (e, t) {
    ...
    try {
      N.apply((D = O.call(w.childNodes)), w.childNodes),
    ...
    function se (e, t, i, r) {
      ...
      if (
        ((i = i || []),
        typeof e != 'string' || !e || (w !== 1 && w !== 9 && w !== 11))
      ) { return i }
      if (!r && (p(t), (t = t || f), v)) {
        if (w !== 11 && (d = Z.exec(e))) {
          if ((o = d[1])) {
            ...
            } else if (g && (l = g.getElementById(o)) && b(t, l) && l.id === o) { return i.push(l), i }
          } else {
        ...
        if (
          ...
          if (((y = e), (g = t), w === 1 && (U.test(e) || $.test(e)))) {
            for (
    ...
    (se.attr = function (e, t) {
      ...
      var o = r && j.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !v) : void 0
      return void 0 !== o
        ? o
        : n.attributes || !v
          ? e.getAttribute(t)
    ...
    ((i = se.selectors =
      {
        ...
        pseudos: {
          ...
          lt: me(function (e, t, n) {
            for (var i = n < 0 ? n + t : t < n ? t : n; --i >= 0;) e.push(i)
            return e
          }),
    ...
    { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })) { i.pseudos[t] = fe(t) }
    ...
    function xe (e, t, n) {
      ...
      return t.first
        ? function (t, n, r) {
          for (; (t = t[i]);) if (t.nodeType === 1 || a) return e(t, n, r)
          return !1
        }
        : function (t, n, c) {
          var l
          ...
          var p = [k, s]
          if (c) {
            for (; (t = t[i]);) { if ((t.nodeType === 1 || a) && e(t, n, c)) return !0 }
          } else {
            for (; (t = t[i]);) {
              if (t.nodeType === 1 || a) {
                if (
                  ...
                  if ((l = u[o]) && l[0] === k && l[1] === s) { return (p[2] = l[2]) }
                  if (((u[o] = p)[2] = e(t, n, c))) return !0
                }
              }
            }
          }
    ...
    function ke (e, t, n, i, r) {
      for (var o, a = [], s = 0, c = e.length, l = t != null; s < c; s++) { (o = e[s]) && ((n && !n(o, i, r)) || (a.push(o), l && t.push(s))) }
      return a
    }
    function Ce (e, t, n, i, r, o) {
      return (
        ...
        le(function (o, a, s, c) {
          ...
          var m = !e || (!o && t) ? v : ke(v, p, e, s, c)
          var y = n ? (r || (o ? e : h || i) ? [] : a) : m
          if ((n && n(m, y, s, c), i)) {
            for (l = ke(y, f), i(l, [], s, c), u = l.length; u--;) { (d = l[u]) && (y[f[u]] = !(m[f[u]] = d)) }
          }
          if (o) {
            if (r || e) {
              if (r) {
                for (l = [], u = y.length; u--;) { (d = y[u]) && l.push((m[u] = d)) }
                r(null, (y = []), l, c)
              }
              for (u = y.length; u--;) {
                (d = y[u]) &&
          ...
          } else (y = ke(y === a ? y.splice(h, y.length) : y)), r ? r(null, a, y, c) : N.apply(a, y)
        })
      )
    }
    function Te (e) {
      for (
        ...
        if ((n = i.relative[e[c].type])) p = [xe(we(p), n)]
        else {
    ...
    return (
      ...
      (s = se.compile =
        function (e, t) {
          ...
          var m = S[e + ' ']
          if (!m) {
            for (t || (t = a(e)), n = t.length; n--;) { (m = Te(t[n]))[x] ? d.push(m) : h.push(m) }
            (m = S(
              e,
              ((r = h),
              (s = (o = d).length > 0),
              ...
              (u = function (e, t, n, a, u) {
                ...
                var x = []
                var w = l
                var C = e || (c && i.find.TAG('*', u))
                var T = (k += w == null ? 1 : Math.random() || 0.1)
                var _ = C.length
                for (
                  u && (l = t == f || t || u);
                  g !== _ && (d = C[g]) != null;
                  ...
                  s && ((d = !m && d) && y--, e && b.push(d))
                }
                if (((y += g), s && g !== y)) {
                  for (h = 0; (m = o[h++]);) m(b, x, t, n)
                  if (e) {
                    if (y > 0) for (; g--;) b[g] || x[g] || (x[g] = P.call(a))
                    x = ke(x)
                  }
                  N.apply(a, x),
                  u &&
      ...
      (c = se.select =
        function (e, t, n, r) {
          ...
          if (((n = n || []), f.length === 1)) {
            ...
            for (
              o = J.needsContext.test(e) ? 0 : c.length;
  ...
  w.fn.extend({
    ...
    is: function (e) {
      return !!D(this, typeof e == 'string' && S.test(e) ? w(e) : e || [], !1)
        .length
    }
  })
  var P = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
  ...
  var N = { children: !0, contents: !0, next: !0, prev: !0 }
  function O (e, t) {
  ...
  w.each(
    {
      ...
      contents: function (e) {
        return e.contentDocument != null && i(e.contentDocument)
          ? e.contentDocument
    ...
    function (e, t) {
      w.fn[e] = function (n, i) {
        ...
        return (
          e.slice(-5) !== 'Until' && (i = n),
          i && typeof i == 'string' && (r = w.filter(i, r)),
          this.length > 1 &&
              (N[e] || w.uniqueSort(r), q.test(e) && r.reverse()),
          this.pushStack(r)
        )
      }
    }
  ...
  (w.Callbacks = function (e) {
    ...
    var l = -1
    var u = function () {
      for (a = a || e.once, o = i = !0; c.length; l = -1) {
    ...
    var d = {
      add: function () {
        return (
          s &&
              (r && !i && ((l = s.length - 1), c.push(r)),
              (function t (n) {
                w.each(n, function (n, i) {
                  h(i)
                    ? (e.unique && d.has(i)) || s.push(i)
                    : i && i.length && b(i) !== 'string' && t(i)
                })
              })(arguments),
              r && !i && u()),
          this
    ...
    Deferred: function (t) {
      ...
      var r = {
        ...
        then: function (t, i, r) {
          ...
          return w
            .Deferred(function (e) {
              n[0][3].add(a(0, e, h(r) ? r : M, e.notifyWith)),
  ...
  var B = function (e, t, n, i, r, o, a) {
    ...
    var c = e.length
    var l = n == null
    if (b(n) === 'object') { for (s in ((r = !0), n)) B(e, t, s, n[s], !0, o, a) } else if (
      void 0 !== i &&
        ((r = !0),
        h(i) || (a = !0),
        l &&
  ...
  w.fn.extend({
    data: function (e, t) {
      ...
      if (void 0 === e) {
        if (
          this.length &&
            ((r = Y.get(o)), o.nodeType === 1 && !V.get(o, 'hasDataAttrs'))
        ) {
          for (n = a.length; n--;) {
            a[n] &&
                (i = a[n].name).indexOf('data-') === 0 &&
  ...
  var ae = function (e, t) {
    return (
      ...
      (e.style.display === '' && re(e) && w.css(e, 'display') === 'none')
    )
  }
  function se (e, t, n, i) {
    var r
            ...
            i.style.display === '' &&
              ...
              (l[u] =
                ...
                (c = ue[s]) ||
                  ...
                  c === 'none' && (c = 'block'),
                  (ue[s] = c)))))
          : n !== 'none' && ((l[u] = 'none'), V.set(i, 'display', n)))
    }
    for (u = 0; u < d; u++) l[u] != null && (e[u].style.display = l[u])
    return e
  }
  w.fn.extend({
    show: function () {
  ...
  (le = m.createElement('input')).setAttribute('type', 'radio'),
  ...
  function be (e, t, n, i, r) {
    ...
    for (d.textContent = '', f = 0; (o = p[f++]);) {
      if (i && w.inArray(o, i) > -1) r && r.push(o)
        ...
        ((l = re(o)), (a = me(d.appendChild(o), 'script')), l && ye(a), n)
  ...
  function Se (e, t, n, i, r, o) {
    var a, s
    if (typeof t == 'object') {
      for (s in (typeof n != 'string' && ((i = i || n), (n = void 0)), t)) { Se(e, s, n, i, t[s], o) }
      return e
    }
    if (
      (i == null && r == null
        ...
        w.event.add(e, t, {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (a.length) { (w.event.special[t] || {}).delegateType && e.stopPropagation() } else if (
                ((a = r.call(arguments)),
                V.set(this, t, a),
                (i = n(this, t)),
                this[t](),
                a !== (o = V.get(this, t)) || i ? V.set(this, t, !1) : (o = {}),
                a !== o)
              ) {
                return (
        ...
        for (l = (t = (t || '').match(L) || ['']).length; l--;) {
          if (
            ...
            a &&
              ...
              delete c[f])
          } else for (f in c) w.event.remove(e, f + t[l], n, i, !0)
        }
        w.isEmptyObject(c) && V.remove(e, 'handle events')
      }
    },
    dispatch: function (e) {
      var t
      ...
      var c = w.event.fix(e)
      var l = (V.get(this, 'events') || Object.create(null))[c.type] || []
      var u = w.event.special[c.type] || {}
      ...
      if (
        ...
        for (
          a = w.event.handlers.call(this, c, l), t = 0;
  ...
  function Oe (e, t) {
    ...
    if (t.nodeType === 1) {
      if (V.hasData(e) && (s = V.get(e).events)) {
        for (r in (V.remove(t, 'handle events'), s)) { for (n = 0, i = s[r].length; n < i; n++) w.event.add(t, r, s[r][n]) }
      }
  ...
  function Le (e, t, n, i) {
    ...
    var m = t[0]
    var y = h(m)
    if (y || (p > 1 && typeof m == 'string' && !f.checkClone && je.test(m))) {
    ...
    if (
      ...
      r.childNodes.length === 1 && (r = a),
      a || i)
    ) {
      for (c = (s = w.map(me(r, 'script'), qe)).length; d < p; d++) {
        (l = r),
        d !== v &&
            ((l = w.clone(l, !0, !0)), c && w.merge(s, me(l, 'script'))),
        n.call(e[d], l, d)
      }
      if (c) {
        for (u = s[s.length - 1].ownerDocument, w.map(s, Ne), d = 0; d < c; d++) {
          (l = s[d]),
          he.test(l.type || '') &&
              ...
              (l.src && (l.type || '').toLowerCase() !== 'module'
                ...
                : g(l.textContent.replace(De, ''), l, u))
        }
      }
    }
    return e
  ...
  function Me (e, t, n) {
    for (var i, r = t ? w.filter(t, e) : e, o = 0; (i = r[o]) != null; o++) {
      n || i.nodeType !== 1 || w.cleanData(me(i)),
      i.parentNode &&
          (n && re(i) && ye(me(i, 'script')), i.parentNode.removeChild(i))
    }
    return e
  }
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (a = me(u), i = 0, r = (o = me(e)).length; i < r; i++) {
          (s = o[i]),
          (l = (c = a[i]).nodeName.toLowerCase()) === 'input' &&
            pe.test(s.type)
            ? (c.checked = s.checked)
            : (l !== 'input' && l !== 'textarea') ||
      ...
      if (t) {
        if (n) {
          for (o = o || me(e), a = a || me(u), i = 0, r = o.length; i < r; i++) { Oe(o[i], a[i]) }
        } else Oe(e, u)
      }
      return (
        (a = me(u, 'script')).length > 0 && ye(a, !d && me(e, 'script')), u
      )
    },
  ...
  w.fn.extend({
    ...
    empty: function () {
      for (var e, t = 0; (e = this[t]) != null; t++) { e.nodeType === 1 && (w.cleanData(me(e, !1)), (e.textContent = '')) }
      return this
    },
    clone: function (e, t) {
      return (
  ...
  function nt (e, t, n, i, r, o) {
    ...
    for (; a < 4; a += 2) {
      n === 'margin' && (c += w.css(e, n + ne[a], !0, r)),
      i
        ? (n === 'content' && (c -= w.css(e, 'padding' + ne[a], !0, r)),
          n !== 'margin' &&
              (c -= w.css(e, 'border' + ne[a] + 'Width', !0, r)))
        : ((c += w.css(e, 'padding' + ne[a], !0, r)),
          n !== 'padding'
            ? (c += w.css(e, 'border' + ne[a] + 'Width', !0, r))
  ...
  function it (e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && r) ||
        ...
        a === 'auto' ||
        (!parseFloat(a) && w.css(e, 'display', !1, i) === 'inline')) &&
        e.getClientRects().length &&
        ((r = w.css(e, 'boxSizing', !1, i) === 'border-box'),
        (o = s in e) && (a = e[s])),
      (a = parseFloat(a) || 0) +
  ...
  w.extend({
    ...
    style: function (e, t, n, i) {
      if (e && e.nodeType !== 3 && e.nodeType !== 8 && e.style) {
        ...
        var l = e.style
        if (
          (c || (t = Xe(s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 === n)
  ...
  w.each(['height', 'width'], function (e, t) {
    w.cssHooks[t] = {
      ...
      set: function (e, n, i) {
        ...
        var s = (a || i) && w.css(e, 'boxSizing', !1, o) === 'border-box'
        var c = i ? nt(e, t, i, s, o) : 0
        return (
          s &&
              a &&
              (c -= Math.ceil(
  ...
  w.each({ margin: '', padding: '', border: 'Width' }, function (e, t) {
    ...
    e !== 'margin' && (w.cssHooks[e + t].set = tt)
  }),
  w.fn.extend({
    css: function (e, t) {
      return B(
    ...
    _default: {
      ...
      set: function (e) {
        w.fx.step[e.prop]
          ? w.fx.step[e.prop](e)
          : e.elem.nodeType !== 1 ||
              (!w.cssHooks[e.prop] && e.elem.style[Xe(e.prop)] == null)
            ? (e.elem[e.prop] = e.now)
  ...
  function pt (e, t, n) {
    ...
    for (
      ...
      if ((i = pt.prefilters[o].call(l, e, u, l.opts))) {
        return (
          h(i.stop) &&
            (w._queueHooks(l.elem, l.opts.queue).stop = i.stop.bind(i)),
          i
        )
      }
    }
  ...
  (w.Animation = w.extend(pt, {
    ...
    prefilters: [
      function (e, t, n) {
        ...
        var f = {}
        var h = e.style
        var v = e.nodeType && ae(e)
        var m = V.get(e, 'fxshow')
        for (i in (n.queue ||
        ...
        if ((c = !w.isEmptyObject(t)) || !w.isEmptyObject(f)) {
          for (i in (d &&
            e.nodeType === 1 &&
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]),
            (l = m && m.display) == null && (l = V.get(e, 'display')),
            (u = w.css(e, 'display')) === 'none' &&
              (l
                ? (u = l)
                : (de([e], !0),
                  (l = e.style.display || l),
          ...
          f)) {
            c ||
              ...
              v && de([e], !0),
              p.done(function () {
                for (i in (v || de([e]), V.remove(e, 'fxshow'), f)) { w.style(e, i, f[i]) }
              })),
            (c = dt(v ? m[i] : 0, i, p)),
            i in m ||
                ((m[i] = c.start), v && ((c.end = c.start), (c.start = 0)))
          }
        }
      }
    ],
  ...
  (Ve = m.createElement('input')),
  (Ye = m.createElement('select').appendChild(m.createElement('option'))),
  (Ve.type = 'checkbox'),
  (f.checkOn = Ve.value !== ''),
  (f.optSelected = Ye.selected),
  ((Ve = m.createElement('input')).value = 't'),
  (Ve.type = 'radio'),
  (f.radioValue = Ve.value === 't')
  var ft = w.expr.attrHandle
  w.fn.extend({
    attr: function (e, t) {
        ...
        return void 0 === e.getAttribute
          ...
          : ((o === 1 && w.isXMLDoc(e)) ||
                (r =
                  ...
                  (w.expr.match.bool.test(t) ? ot : void 0)),
            void 0 !== n
              ? n === null
  ...
  function gt (e) {
    return Array.isArray(e) ? e : (typeof e == 'string' && e.match(L)) || []
  }
  w.fn.extend({
    prop: function (e, t) {
  ...
  w.fn.extend({
    ...
    toggleClass: function (e, t) {
      var n = typeof e
      var i = n === 'string' || Array.isArray(e)
      return typeof t == 'boolean' && i
        ...
        : h(e)
          ...
          : this.each(function () {
            var t, r, o, a
            if (i) {
              for (r = 0, o = w(this), a = gt(e); (t = a[r++]);) { o.hasClass(t) ? o.removeClass(t) : o.addClass(t) }
            } else {
              (void 0 !== e && n !== 'boolean') ||
                  ((t = yt(this)) && V.set(this, '__className__', t),
                  this.setAttribute &&
                    this.setAttribute(
                      'class',
    ...
    hasClass: function (e) {
      ...
      var i = 0
      for (t = ' ' + e + ' '; (n = this[i++]);) {
        if (n.nodeType === 1 && (' ' + mt(yt(n)) + ' ').indexOf(t) > -1) { return !0 }
      }
      return !1
    }
  })
      ...
      return arguments.length
        ? ((i = h(e)),
          this.each(function (n) {
            var r
            this.nodeType === 1 &&
              ((r = i ? e.call(this, n, w(this).val()) : e) == null
                ? (r = '')
                : typeof r == 'number'
                  ? (r += '')
                  : Array.isArray(r) &&
  ...
  w.extend(w.event, {
    trigger: function (t, n, i, r) {
      ...
      var f
      var y = [i || m]
      var g = u.call(t, 'type') ? t.type : t
      var b = u.call(t, 'namespace') ? t.namespace.split('.') : []
      if (
        ((a = f = s = i = i || m),
        i.nodeType !== 3 &&
          i.nodeType !== 8 &&
          !xt.test(g + w.event.triggered) &&
          (g.indexOf('.') > -1 && ((g = (b = g.split('.')).shift()), b.sort()),
          (l = g.indexOf(':') < 0 && 'on' + g),
          ((t = t[w.expando]
            ? t
            : new w.Event(g, typeof t == 'object' && t)).isTrigger = r ? 2 : 3),
          (t.namespace = b.join('.')),
        ...
        if (!r && !p.noBubble && !v(i)) {
          for (
            c = p.delegateType || g, xt.test(c + g) || (a = a.parentNode);
            a;
            a = a.parentNode
          ) { y.push(a), (s = a) }
          s === (i.ownerDocument || m) &&
        ...
        return (
          ...
          r ||
            ...
            (l &&
              ...
              ((s = i[l]) && (i[l] = null),
              (w.event.triggered = g),
              t.isPropagationStopped() && f.addEventListener(g, wt),
              i[g](),
              t.isPropagationStopped() && f.removeEventListener(g, wt),
  ...
  var Et = /^(?:input|select|textarea|keygen)/i
  function jt (e, t, n, i) {
    var r
    if (Array.isArray(t)) {
  ...
  var It = {}
  var Ht = '*/'.concat('*')
  var Rt = m.createElement('a')
  function zt (e) {
    return function (t, n) {
      var i
      typeof t != 'string' && ((n = t), (t = '*'))
      var r = 0
      var o = t.toLowerCase().match(L) || []
      if (h(n)) {
        for (; (i = o[r++]);) {
          i[0] === '+'
  ...
  function Bt (e, t) {
    var n
    var i
    var r = w.ajaxSettings.flatOptions || {}
  ...
  w.extend({
    ...
    ajaxTransport: zt(It),
    ajax: function (t, n) {
      var i, r, o, a, s, c, l, u, d, p
      typeof t == 'object' && ((n = t), (t = void 0)), (n = n || {})
      var f = w.ajaxSetup({}, n)
      var h = f.context || f
      var v = f.context && (h.nodeType || h.jquery) ? w(h) : w.event
      var y = w.Deferred()
      var g = w.Callbacks('once memory')
      var b = f.statusCode || {}
      var x = {}
      var k = {}
      var C = 'canceled'
      var T = {
        ...
        overrideMimeType: function (e) {
          return l == null && (f.mimeType = e), this
        },
      ...
      f.headers)) { T.setRequestHeader(d, f.headers[d]) }
      ...
      if (
        ...
        if (((T.readyState = 1), u && v.trigger('ajaxSend', [T, f]), l)) { return T }
        f.async &&
            f.timeout > 0 &&
            ...
            d
              ? (f.ifModified &&
                  ((k = T.getResponseHeader('Last-Modified')) &&
                    (w.lastModified[r] = k),
                  (k = T.getResponseHeader('etag')) && (w.etag[r] = k)),
                t === 204 || f.type === 'HEAD'
                  ? (C = 'nocontent')
                  : t === 304
                    ? (C = 'notmodified')
                    : ((C = x.state), (p = x.data), (d = !(m = x.error))))
              : ((m = C), (!t && C) || ((C = 'error'), t < 0 && (t = 0))),
            (T.status = t),
            (T.statusText = (n || C) + ''),
            d ? y.resolveWith(h, [p, C, T]) : y.rejectWith(h, [T, C, m]),
            T.statusCode(b),
            (b = void 0),
  ...
  w.fn.extend({
    ...
    position: function () {
      if (this[0]) {
        ...
        var i = this[0]
        var r = { top: 0, left: 0 }
        if (w.css(i, 'position') === 'fixed') t = i.getBoundingClientRect()
        else {
          for (
            t = this.offset(),
            n = i.ownerDocument,
    ...
    return this.each(function () {
      ...
      t.waypoint(
        function (o) {
          !(function () {
            var o = []
            var a = r.time / r.delay
            var s = e(this).attr('data-num')
              ? e(this).attr('data-num')
              : t.text()
            var c = /[0-9]+,[0-9]+/.test(s)
            var l = ((s = s.replace(/,/g, '')).split('.')[1] || []).length
            r.beginAt > s && (r.beginAt = s)
            var u = /[0-9]+:[0-9]+:[0-9]+/.test(s)
            if (u) {
              var d = s.split(':')
              var p = 1
              for (n = 0; d.length > 0;) { (n += p * parseInt(d.pop(), 10)), (p *= 60) }
            }
            for (var f = a; f >= (r.beginAt / s) * a; f--) {
              var h = parseFloat((s / a) * f).toFixed(l)
              if (u) {
                h = parseInt((n / a) * f)
                var v = parseInt(h / 3600) % 24
                var m = parseInt(h / 60) % 60
                var y = parseInt(h % 60, 10)
                h =
                    (v < 10 ? '0' + v : v) +
                    ':' +
                    (m < 10 ? '0' + m : m) +
              ...
              if (c) {
                for (; /(\d+)(\d{3})/.test(h.toString());) { h = h.toString().replace(/(\d+)(\d{3})/, '$1,$2') }
              }
              i.formatter && (h = i.formatter.call(this, h)), o.unshift(h)
            }
    ...
    easeInOutElastic: function (e) {
      return e === 0
        ...
        : e === 1
          ? 1
          : e < 0.5
            ? (-t(2, 20 * e - 10) * i((20 * e - 11.125) * l)) / 2
            : (t(2, -20 * e + 10) * i((20 * e - 11.125) * l)) / 2 + 1
    },
...
(function () {
  ...
  (t.prototype.checkEmpty = function () {
    ...
    var n = this.element == this.element.window
  ...
  (t.prototype.refresh = function () {
    ...
    var n = t ? void 0 : this.adapter.offset()
    var i = {}
    ...
    (e = {
      ...
      for (var s in this.waypoints[o]) {
        ...
        var f = p.options.offset
        var h = p.triggerPoint
        var v = 0
        var m = h == null
        ...
        (p.triggerPoint = Math.floor(v + c - f)),
        (l = h < a.oldScroll),
  ...
  e.fn.extend({
    venobox: function (Z) {
      ...
      return (
        te.cb_init(ee),
        this.each(function () {
          if ((q = e(this)).data('venobox')) return !0
          function Z () {
            (T = q.data('gall')),
            (x = q.data('numeratio')),
            (v = q.data('gallItems')),
            ...
            (U = q.data('share')),
            o.html(''),
            q.data('vbtype') !== 'iframe' &&
                  q.data('vbtype') !== 'inline' &&
                  q.data('vbtype') !== 'ajax' &&
                  ((X = {
                    pinterest:
            ...
            (y = v || e('.vbox-item[data-gall="' + T + '"]')).length < 2 &&
                  ((m = !1), (x = !1)),
            (_ = y.eq(y.index(q) + 1)),
            (S = y.eq(y.index(q) - 1)),
            _.length || !0 !== m || (_ = y.eq(0)),
            y.length >= 1
              ? ((N = y.index(q) + 1), r.html(N + ' / ' + y.length))
              : (N = 1),
            !0 === x ? r.show() : r.hide(),
            C !== '' ? a.show() : a.hide(),
            _.length || !0 === m
              ? (e('.vbox-next').css('display', 'block'), (A = !0))
              : (e('.vbox-next').css('display', 'none'), (A = !1)),
            y.index(q) > 0 || !0 === m
              ? (e('.vbox-prev').css('display', 'block'), (E = !0))
              : (e('.vbox-prev').css('display', 'none'), (E = !1)),
            (!0 !== E && !0 !== A) ||
                  (u.on(le.DOWN, ae), u.on(le.MOVE, se), u.on(le.UP, ce))
          }
          function ne (e) {
            return (
              !(e.length < 1) &&
                ...
                e === S && u.addClass('vbox-animated').addClass('swipe-right'),
                e === _ && u.addClass('vbox-animated').addClass('swipe-left'),
                D.show(),
                void u.animate({ opacity: 0 }, 500, function () {
                  k.css('background', w),
                  u
                  ...
                  Z(),
                  (g = !1),
                  te.cb_after_nav(q, N, _, S)
                }))
            )
          }
          function ie (e) {
            e.keyCode === 27 && re(),
            e.keyCode == 37 && !0 === E && ne(S),
            e.keyCode == 39 && !0 === A && ne(_)
          }
          function re () {
            if (!1 === te.cb_pre_close(q, N, _, S)) return !1
            e('body').off('keydown', ie).removeClass('vbox-open'),
            q.focus(),
            k.animate({ opacity: 0 }, 500, function () {
              k.remove(), (g = !1), te.cb_post_close()
            })
          }
          (ee.VBclose = function () {
            re()
          }),
          q.addClass('vbox-item'),
          q.data('framewidth', te.framewidth),
          q.data('frameheight', te.frameheight),
          q.data('border', te.border),
          q.data('bgcolor', te.bgcolor),
          q.data('numeratio', te.numeratio),
          q.data('gallItems', te.gallItems),
          q.data('infinigall', te.infinigall),
          q.data('overlaycolor', te.overlayColor),
          q.data('titleattr', te.titleattr),
          q.data('share', te.share),
          q.data('venobox', !0),
          q.on('click', function (v) {
            if (
              (v.preventDefault(), (q = e(this)), !1 === te.cb_pre_open(q))
            ) { return !1 }
            switch (
              ((ee.VBnext = function () {
                ne(_)
              ...
              (w = q.data('overlay') || q.data('overlaycolor')),
              (f = q.data('framewidth')),
              (h = q.data('frameheight')),
              (t = q.data('autoplay') || te.autoplay),
              (s = q.data('border')),
              (n = q.data('bgcolor')),
              (A = !1),
              (E = !1),
              (g = !1),
              (d = q.data('href') || q.attr('href')),
              (p = q.data('css') || ''),
              (C = q.attr(q.data('titleattr')) || ''),
              (U = q.data('share')),
              (j = '<div class="vbox-preloader">'),
              te.spinner)
            ) {
              case 'rotating-plane':
            ...
            return (
              ...
              e('body').append(c).addClass('vbox-open'),
              e(
              ...
              ).css('background-color', te.spinColor),
              (k = e('.vbox-overlay')),
              (l = e('.vbox-container')),
              (u = e('.vbox-content')),
              (i = e('.vbox-left')),
              ...
              (Q = te.titlePosition == 'top' ? 'bottom' : 'top'),
              o.css(Q, '-1px'),
              o.css({
                color: te.titleColor,
                fill: te.titleColor,
              ...
              i.css(te.numerationPosition, '-1px'),
              i.css({
          ...
          function se (e) {
            if (!0 === O) {
              (z = e.pageX), (R = e.pageY), (B = z - H), (W = R - I)
              var t = Math.abs(B)
              t > Math.abs(W) &&
                  t <= 100 &&
                  (e.preventDefault(), u.css('margin-left', B))
            }
          }
          function ce (e) {
            if (!0 === O) {
          ...
          te.overlayClose || (oe = '.vbox-close'),
          e('body').on('click touchstart', oe, function (t) {
          ...
          var de = function (t) {
            ...
            (i =
                  n == le.UP
                    ? pe(n, t, null, null)
                    : pe(n, t, r.pageX, r.pageY)),
            e(t.target).trigger(i)
          }
          var pe = function (t, n, i, r) {
            return e.Event(t, { pageX: i, pageY: r, originalEvent: n })
          }
          function fe () {
            e.ajax({ url: d, cache: !1 })
              .done(function (e) {
                u.html('<div class="vbox-inline">' + e + '</div>'), ye()
              })
              .fail(function () {
                u.html(
          ...
          function he () {
            u.html('<iframe class="venoframe" src="' + d + '"></iframe>'),
            ge()
          }
          function ve (e) {
            var t
            ...
            var i =
                  ...
                  (function (e) {
                    var t = ''
                    var n = decodeURIComponent(d).split('?')
                    if (void 0 !== n[1]) {
                      var i
                      var r
                      var o = n[1].split('&')
                      for (r = 0; r < o.length; r++) { t = t + '&' + (i = o[r].split('='))[0] + '=' + i[1] }
                    }
                    return encodeURI(t)
                  })()
            n.type == 'vimeo'
              ? (t = 'https://player.vimeo.com/video/')
              : n.type == 'youtube' && (t = 'https://www.youtube.com/embed/'),
            u.html(
          ...
          function me () {
            u.html('<div class="vbox-inline">' + e(d).html() + '</div>'),
            ge()
          }
          function ye () {
            (M = u.find('img')).length
          ...
          function ge () {
            ...
            u
              ...
              .css({ width: f, height: h, padding: s, background: n }),
            e('img.vbox-figlio').on('dragstart', function (e) {
              e.preventDefault()
            }),
            l.scrollTop(0),
            be(),
            u.animate({ opacity: '1' }, 'slow', function () {
              D.hide()
            }),
            te.cb_content_loaded(q, N, _, S)
          }
          function be () {
            var t = u.outerHeight()
            ...
            (b = t + 60 < n ? (n - t) / 2 : '30px'),
            u.css('margin-top', b),
            u.css('margin-bottom', b),
            te.cb_post_resize()
          }
          'ontouchstart' in window
            ? (e(document).on('touchstart', de),
              e(document).on('touchmove', de),
              e(document).on('touchend', de))
            : (e(document).on('mousedown', ue),
              e(document).on('mouseup', ue),
              e(document).on('mouseout', ue),
              e(document).on('mousemove', ue)),
            ...
            },
            {
              ...
              value: function () {
                ...
                (this.timeout = setTimeout(function () {
                  e.currentElContent && e.currentElContent.length !== 0
                    ? e.backspace(
                      e.currentElContent,
                ...
                return !0 === this.pause.status
                  ...
                  : void (this.timeout = setTimeout(function () {
                    ...
                    if (a.charAt(0) === '`') {
                      ...
                      var l = e.substring(c.length + 1, t + r)
                      var u = e.substring(t + r + 1);
                      (e = c + l + u), r--
                    }
...
(function (e) {
  'use strict'
  const t = e('#header').outerHeight() - 21
  if (
    (e(document).on(
      'click',
    ...
    e(document).ready(function () {
      if (window.location.hash) {
        ...
        if (e(n).length) {
          const i = e(n).offset().top - t
          e('html, body').animate({ scrollTop: i }, 1500, 'easeInOutExpo')
        }
      }
    }),
    e('.nav-menu').length)
  ) {
    const t = e('.nav-menu').clone().prop({ class: 'mobile-nav d-lg-none' })
    e('body').append(t),
    e('body').prepend(
    ...
    e(document).click(function (t) {
      const n = e('.mobile-nav, .mobile-nav-toggle')
      n.is(t.target) ||
            n.has(t.target).length !== 0 ||
            (e('body').hasClass('mobile-nav-active') &&
              (e('body').removeClass('mobile-nav-active'),
              e('.mobile-nav-toggle i').toggleClass(
                'icofont-navigation-menu icofont-close'
  ...
  const n = e('section')
  const i = e('.nav-menu, .mobile-nav')
  if (
    (e(window).on('scroll', function () {
      const t = e(this).scrollTop() + 200
      n.each(function () {
        const n = e(this).offset().top
        const r = n + e(this).outerHeight()
        t >= n &&
            t <= r &&
            (t <= r && i.find('li').removeClass('active'),
            i
              .find('a[href="#' + e(this).attr('id') + '"]')
              .parent('li')
              .addClass('active')),
        t < 300 && e('.nav-menu ul:first li:first').addClass('active')
      })
    }),
    ...
    e('.text-slider').length == 1)
  ) {
    const t = e('.text-slider-items').text()
...
var pJS = function (e, t) {
  ...
  (i.fn.particle.prototype.draw = function () {
    ...
    if (e.opacity_bubble != null) var n = e.opacity_bubble
    else n = e.opacity
    if (e.color.rgb) {
      var r =
          'rgba(' +
    ...
    switch (
      ...
      case 'star':
        ...
        break
      case 'image':
        if (i.tmp.img_type == 'svg') var o = e.img.obj
  ...
  (i.fn.interact.attractParticles = function (e, t) {
    ...
    if (Math.sqrt(n * n + r * r) <= i.particles.line_linked.distance) {
      ...
      var a = r / (1e3 * i.particles.move.attract.rotateY);
        ...
        if (i.tmp.bubble_duration_end) {
          r != null &&
              ((c =
                t +
                (t -
                  (o - (d * (o - t)) / i.interactivity.modes.bubble.duration))),
              a == 'size' && (e.radius_bubble = c),
              a == 'opacity' && (e.opacity_bubble = c))
          ...
          a == 'size' && (e.radius_bubble = void 0),
          a == 'opacity' && (e.opacity_bubble = void 0)
        }
      }
    }
    if (
      ...
      var o = e.y - i.interactivity.mouse.pos_y
      var a =
            1 -
            (u = Math.sqrt(r * r + o * o)) /
              i.interactivity.modes.bubble.distance
      if (u <= i.interactivity.modes.bubble.distance) {
        if (a >= 0 && i.interactivity.status == 'mousemove') {
          if (i.interactivity.modes.bubble.size != i.particles.size.value) {
            if (i.interactivity.modes.bubble.size > i.particles.size.value) {
              (c = e.radius + i.interactivity.modes.bubble.size * a) >= 0 &&
                  (e.radius_bubble = c)
            } else {
      ...
      i.interactivity.status == 'mouseleave' && t()
    } else if (
      ...
      if (i.tmp.bubble_clicking) {
        ...
        var d = (new Date().getTime() - i.interactivity.mouse.click_time) / 1e3
  ...
  (i.fn.modes.repulseParticle = function (e) {
    if (
      ...
      var o = { x: t / r, y: n / r }
      var a = clamp(
        (1 / (c = i.interactivity.modes.repulse.distance)) *
              (-1 * Math.pow(r / c, 2) + 1) *
              c *
              100,
        0,
      ...
      if (
        ...
        var l = i.interactivity.mouse.click_pos_x - e.x
        var u = i.interactivity.mouse.click_pos_y - e.y
        var d = l * l + u * u
        var p = (-c / d) * 1
        c >= d &&
            (function () {
  ...
  (i.fn.vendors.densityAutoParticles = function () {
    if (i.particles.number.density.enable) {
      ...
      var n = i.particles.array.length - t
      n < 0
  ...
  (i.fn.vendors.createSvgImg = function (e) {
    ...
    var n = new Blob([t], { type: 'image/svg+xml;charset=utf-8' })
    var r = window.URL || window.webkitURL || window
    var o = r.createObjectURL(n)
    var a = new Image()
  ...
  (i.fn.vendors.drawShape = function (e, t, n, i, r, o) {
    ...
    var s = r / o
    var c = (180 * (s - 2)) / s
    var l = Math.PI - (Math.PI * c) / 180
    e.save(), e.beginPath(), e.translate(t, n), e.moveTo(0, 0)
    for (var u = 0; a > u; u++) { e.lineTo(i, 0), e.translate(i, 0), e.rotate(l) }
    e.fill(), e.restore()
  }),
  ...
  (i.fn.vendors.checkBeforeDraw = function () {
    i.particles.shape.type == 'image'
      ? i.tmp.img_type == 'svg' && i.tmp.source_svg == null
...
(window.particlesJS = function (e, t) {
  ...
  var r = n.getElementsByClassName(i)
  if (r.length) for (; r.length > 0;) n.removeChild(r[0])
  var o = document.createElement('canvas');
  (o.className = i),
  (o.style.width = '100%'),
  (o.style.height = '100%'),
  document.getElementById(e).appendChild(o) != null &&
