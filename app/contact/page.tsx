			...
			<div className='h-full w-full overflow-y-auto'>
				<div className='container mx-auto h-full items-center py-6 text-left md:py-12 lg:py-24'>
					<Motion.div direction='right' delay={0.1} className='md:px-6'>
						<p className='text-secondary text-xs tracking-wider uppercase lg:text-base'>Get in touch</p>
					...
					<Motion.div
						direction='right'
						delay={0.3}
						className='text-secondary mx-auto mt-4 max-w-3xl pb-40 text-justify text-sm leading-6 md:px-6 lg:mx-0 lg:pb-12 lg:text-lg xl:max-w-5xl'>
