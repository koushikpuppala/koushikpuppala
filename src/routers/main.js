...
router.get("/", (req, res) => {
	res.render("index", {
		...
		DESCRIPTION:
			"Koushik Puppala is a Student at the Indian Institute of Information Technology, Raichur. I am making few Websites, helping with the IIITR website, and making a few apps",
		KEYWORDS:
...
router.post(
	...
	[
		...
		check("Message", "You must Enter Message what you want to tell")
			.not()
			.isEmpty(),
	],
	(req, res) => {
